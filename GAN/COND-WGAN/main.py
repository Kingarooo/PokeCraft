...
from utils import generate_image, initialize_weights, gradient_penalty
import os
...
#handle arguments
if len(argv) < 2:
  print("Usage: python main.py [train|clean|generate] [model_path]")
  exit()
...
if argv[1] == 'clean':
  ...
  generate_image(0, gen, device, Z_DIM)
  exit()
elif argv[1] == 'train':
  pass
...
for epoch in range(NUM_EPOCHS):
  for batch_idx, (real, labels) in enumerate(loader):
    ...
    for _ in range(CRITIC_ITERATIONS):
            ...
            gp = gradient_penalty(critic, labels,real, fake, device=device) #type: ignore
            loss_critic = (
